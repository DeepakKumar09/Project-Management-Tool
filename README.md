...
Open the [ppmtool-react-client](https://github.com/DeepakYdv28 "ppmtool-react-client") folder and install the npm packages using the following commands
...
Go to [project_management_tool](https://github.com/DeepakYdv28 "project_management_tool") folder and start the Application using the following commands
